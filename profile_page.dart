            ...
            Wrap(
              ...
              children: _avatarOptions
                  .map(
                    (e) => GestureDetector(
                      onTap: () {
                        setState(() => widget.profile.avatarEmoji = e);
                      ...
                      child: Container(
                        ...
                        height: 60,
                        decoration: BoxDecoration(
                          color: widget.profile.avatarEmoji == e
        ...
        child: Column(
          children: [
            ...
            _profileCard(
              ...
              child: Row(
                children: [
                  _miniStat('${p.pets.length}', 'Pets', kNavy),
                  _vDivider(),
                  _miniStat(
                    p.role == 'Delivery Agent' ? '34' : '5',
                    p.role == 'Delivery Agent' ? 'Deliveries' : 'Bookings',
                    kSky,
                  ),
                  _vDivider(),
                  _miniStat(
                    p.role == 'Delivery Agent' ? '4.8' : '4.5',
                    'Rating',
                    kOrange,
                  ),
                ],
        ...
        Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: kNavy, size: 16),
            ),
